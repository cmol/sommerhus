...
else
{
	...
	if($good)
	{
		...
		<div id="left">';
			...
			{
				$id = $_GET['id'];
				mysql_query("UPDATE blog_post SET title = '$title', text = '$text', tags = '$tags', last_edit = '$date' WHERE id = '$id' LIMIT 1") or die(mysql_error());
			...
			else
			{
				...
				mysql_query("INSERT INTO blog_post (title, text, tags, author, date) VALUES ('$title', '$text', '$tags', '$author', '$date')") or die(mysql_error());
